/**
 * Channel Router — resolves IM addresses to NoonFlow sessions.
 *
...
/**
 * Create a new binding with a fresh NoonFlow session.
 */
...
/**
 * Bind an IM chat to an existing NoonFlow session.
 */
