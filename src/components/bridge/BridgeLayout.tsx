...
import { MessageMultiple01Icon, Wifi01Icon } from "@hugeicons/core-free-icons";
...
const sidebarItems: SidebarItem[] = [
  { id: "bridge", labelKey: "bridge.title", icon: Wifi01Icon },
  { id: "telegram", labelKey: "bridge.telegramSettings", icon: MessageMultiple01Icon },
];
