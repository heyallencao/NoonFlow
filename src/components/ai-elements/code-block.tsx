...
export const CodeBlockContainer = ({
  ...
  <div
    className={cn(
      "group relative w-full overflow-hidden rounded-xl border border-transparent bg-foreground/[0.03] text-foreground",
      className
    )}
...
export const CodeBlockHeader = ({
  ...
  <div
    className={cn(
      "flex items-center justify-between px-4 py-2 text-muted-foreground/60 text-[11px] font-medium tracking-tight",
      className
    )}
    {...props}
  >
...
export const CodeBlockActions = ({
  ...
  <div
    className={cn(
      "flex items-center gap-1 rounded-md bg-foreground/[0.03] p-0.5 border border-foreground/[0.05]",
      className
    )}
    {...props}
  >
...
export const CodeBlockCopyButton = ({
  ...
  return (
    <Button
      className={cn(
        "size-7 p-0 text-muted-foreground/60 hover:text-foreground hover:bg-foreground/5 transition-all",
        className
      )}
