...
import { publishImageGenerationCompleted } from '@/lib/events/app-event-bus';
...
export function ImageGenConfirmation({
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      if (genResult.images.length > 0) {
        ...
        setTimeout(() => {
          publishImageGenerationCompleted({
            prompt,
            aspectRatio,
            resolution,
  ...
  return (
    <div className="rounded-lg bg-bg-tertiary overflow-hidden my-2">
      {/* Header */}
