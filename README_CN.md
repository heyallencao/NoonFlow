...
这个仓库当前先作为 CairnStack 的公开入口，用来承接 releases、文档和反馈。公开源码可以按阶段继续补进来。
...
CairnStack 想做的，就是把这些东西重新拉回一个工作台里，让 AI coding 没那么碎，也更容易长期管理。
...
CairnStack 主要面向已经在高频使用 Claude Code 或 Codex、并且想要的不只是 terminal wrapper 的开发者。
...
- 下载：[GitHub Releases](https://github.com/heyallencao/CairnStack/releases)
...
- Bug 与安装问题：[GitHub Issues](https://github.com/heyallencao/CairnStack/issues)
- 想法与产品讨论：[GitHub Discussions](https://github.com/heyallencao/CairnStack/discussions)
